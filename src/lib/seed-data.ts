...
export const seedFacilities: Omit<Facility, 'id' | 'created_at' | 'updated_at'>[] = [
  {
    ...
    description:
      'A fully equipped center for effective physiotherapy treatments. Our experienced and clinically versatile physiotherapist are immensely knowledgeable in clinical reasoning and hypothesizing the clinical impressions. We offer world-class physiotherapy at clinic, home, or online — choose what works for you!',
    website_url: 'https://activecarephysio.in/',
    google_business_url: 'https://activecarephysio.in/',
    phone: '+91 7447447306',
    phone_secondary: '+91 7092550824',
  ...
  },
  {
    ...
    address: 'Ramaiah Nagar, Medavakkam, Chennai, Tamil Nadu 600100, India',
    city: 'Chennai',
    state: 'Tamil Nadu',
  ...
  },
  {
    ...
    phone: '+91 9884122274',
    phone_secondary: '+91 7447447306',
    email: 'ActiveCarePhysio22@gmail.com',
    address: 'Chengam Road, Near Sri Ramana Ashram, Tiruvannamalai, Tamil Nadu 606603',
    city: 'Tiruvannamalai',
    state: 'Tamil Nadu',
